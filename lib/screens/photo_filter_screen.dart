...
class PhotoFilterSection extends StatefulWidget {
  const PhotoFilterSection({Key? key}) : super(key: key);

  @override
  State<PhotoFilterSection> createState() => _PhotoFilterSectionState();
}

class _PhotoFilterSectionState extends State<PhotoFilterSection> {
  final _filters = [
    Colors.white,
  ...
  void _onFilterChanged(Color val) {
    _filterColor.value = val;
  }

  @override
  Widget build(BuildContext context) {
    print("Colors.primaries: ${Colors.primaries}");
    return Container(
      child: Stack(
        children: [
